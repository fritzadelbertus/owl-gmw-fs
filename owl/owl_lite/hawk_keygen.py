from hawk.poly import adjoint, isinvertible, poly_mul_ntt, poly_add, infnorm, l2norm
from hawk.ntrugen.ntrugen_hawk import ntru_solve
import hawk.ntrugen
from hawk.params import PARAMS
from hawk.codec import encode_public, encode_private
import hashlib
import numpy as np
from hawk.rngcontext import RngContext, SHAKE256x4


def keygen(logn, rng=None):
    """
...
def hawkkeygen_unpacked(logn, rng=None):
    ...
    priv = encode_private(kgseed, F, G)
