...
def matrix_mult(A, B):
    p = 8380417
    c00 = poly_add_p(
        poly_mul_ntt(A[0][0], B[0][0], p), poly_mul_ntt(A[0][1], B[1][0], p), p
    )
    c01 = poly_add_p(
        poly_mul_ntt(A[0][0], B[0][1], p), poly_mul_ntt(A[0][1], B[1][1], p), p
    )
    c10 = poly_add_p(
        poly_mul_ntt(A[1][0], B[0][0], p), poly_mul_ntt(A[1][1], B[1][0], p), p
    )
    c11 = poly_add_p(
        poly_mul_ntt(A[1][0], B[0][1], p), poly_mul_ntt(A[1][1], B[1][1], p), p
    )
