...
def owl_Sign(privateKeyInBits, publicKeyInBits, messageInBits):
    return Sign(
        privateKeyInBits=privateKeyInBits,
        publicKeyInBits=publicKeyInBits,
        messageInBits=messageInBits,
        setElementLengthInBits=setElementLengthInBits,
        groupElementLengthInBits=groupElementLengthInBits,
        r=r,
        c=c,
        hash_function=owl_hash,
        group_sampler=group_sampler,
        action=owl_action,
        group_operator=group_operator,
        group_inverse=group_inverse,
        bitsToGroup=bitsToGroup,
        bitsToSet=bitsToSet,
        setToBits=setToBits,
        groupToBits=groupToBits,
    )
